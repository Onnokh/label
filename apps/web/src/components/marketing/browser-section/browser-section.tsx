...
export function BrowserSection() {
  return (
    <section className={styles.section} aria-labelledby="browser-title">
      ...
      <p>One click in the <Link className={styles.inlineLink} to="/chrome-extension">Chrome read-later extension</Link> saves the tab you're on. The full library opens in the web app.</p>
